...
nick = User.create(username: 'Nick', password: 'nick', first_name: 'Nicolas', last_name: 'Cha', favorite_player:  'Kante')
bob = User.create(username: 'Bob', password: 'bob', first_name: 'Bob', last_name: 'Lang', favorite_player:  'Abraham')
